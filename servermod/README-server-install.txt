...
4. Copy @arma_attendance_server/arma_attendance.example.toml to @arma_attendance_server/arma_attendance.toml.
5. Edit arma_attendance.toml with the real API base URL, API token, and server key.
6. Launch with:
   -mod=@CBA_A3;@arma_attendance -serverMod=@arma_attendance_server
7. In Zeus, place Attendance: Debug API Poke.
8. Check the server RPT for the JSON response.
